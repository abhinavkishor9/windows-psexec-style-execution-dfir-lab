# Investigation Notes — PsExec-Style Execution

## Investigation Overview

**Lab:** Windows PsExec-Style Execution Investigation  
**Host:** `DESKTOP-9MMM37V`  
**User:** `desktop-9mmm37v\dell`  
**PowerShell:** `7.6.6`  
**Sysmon:** Running  
**Wazuh:** Running  
**Lab Service:** `PsExecStyleLabSvc`

---

## Investigation Objective

Determine whether the controlled service installation generated evidence consistent with PsExec-style execution and whether the available telemetry could establish successful or remote execution.

The investigation specifically avoids treating the service name itself as proof of malicious activity.
