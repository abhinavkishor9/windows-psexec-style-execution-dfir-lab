# Troubleshooting Notes — PsExec-Style Execution Lab
...
The investigation was changed to focus on:
...
rather than forcing successful execution from an artificial service.

---

## Final Troubleshooting Principle

The most important lesson from the troubleshooting process is:

> **Do not modify the evidence simply to make the expected result appear.**

When a service failed to start, the failure became part of the investigation.

When Security events were unavailable, they were documented as telemetry gaps.

When Sysmon contained many unrelated events, they were not automatically attributed to the lab.

This keeps the investigation reproducible and defensible.
